...
function LaunchIntentFunction (intent, session, response) {
  var output = 'Welcome to Find LinkNYC.  You can find out where the nearest LinkNYC kiosk is based off your current location.  To start using the skill, say Alexa, ask linkNYC to give me the nearest link kiosk. '
  response.ask(output)
  return
}
